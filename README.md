...
| /api/create/<br>**Параметры**<br>*reserved_from:* **str** *"yyyy-mm-dd hh:mm"*<br>*reserved_to:* **str** *"yyyy-mm-dd hh:mm"*<br>*workplace:* **int**    | Создать бронирование    | POST<br>![alt text](https://img.shields.io/static/v1?label=&message=AUTH&color=red "AUTH") | 201<br>403 |
